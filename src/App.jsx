...
const RESEND_API_KEY = "re_GFYsMP3Y_FRLuxT3WGimport { useState, useEffect } from "react";
import { db } from "./firebase";
import { collection, doc, setDoc, getDocs, deleteDoc } from "firebase/firestore";
...
async function sendDepartEmail(emailClient, dossier) {
  try {
    const html = await generateDepartHTML(dossier);
    ...
    console.error("Email depart error:", e);
            ...
            {depStep===2&&(
              <div>
                ...
                <div className="card no-print" style={{marginTop:14}}>
                  ...
                  {depEmailSent&&<div style={{fontSize:12,color:"var(--ok)",marginBottom:8,fontWeight:600}}>✓ État de départ envoyé au client</div>}
                </div>
                <div className="no-print" style={{marginTop:10,display:"flex",justifyContent:"space-between",gap:8}}>
                  ...
                  <button className="btn btn-gold" disabled={depEmailSending} onClick={async()=>{
                    const d=await saveDepart();
                    if(depForm.email.trim()) {
                      setDepEmailSending(true);
                      const result=await sendDepartEmail(depForm.email, d);
                      setDepEmailSending(false);
                      if(result.ok) { setDepEmailSent(true); setTimeout(()=>goHome(), 1500); }
                      else alert("Erreur envoi : "+result.error);
                    } else {
                      goHome();
                    }
                  }}>{depEmailSending?"Envoi en cours...":depForm.email.trim()?"✓ Valider & envoyer au client":"✓ Valider & sauvegarder"}</button>
                </div>
              </div>
            )}
          </div>
            ...
            {retStep===2&&foundDossier&&(
              <div>
                ...
                <div className="card" style={{marginBottom:14}}>
                  ...
                  {emailSent&&<div style={{fontSize:12,color:"var(--ok)",marginTop:8,fontWeight:600}}>✓ Email envoyé avec succès</div>}
                </div>
                <div style={{display:"flex",justifyContent:"space-between",gap:10}}>
                  <button className="btn btn-outline" onClick={()=>setRetStep(1)}>← Modifier</button>
                  <button className="btn btn-outline btn-sm no-print" onClick={()=>window.print()}>⬇ PDF</button>
                  <button className="btn btn-gold" disabled={emailSending} onClick={async()=>{
                    const d=await saveRetour();
                    setActiveDossier(d);
                    if(emailClient.trim()) {
                      setEmailSending(true);
                      const vTaux = getVetuste(d.info?.annee_fab);
                      const result = await sendExpertiseEmail(emailClient, d, tarifs, zones, vTaux);
                      setEmailSending(false);
                      if(result.ok) setEmailSent(true);
                      else alert("Erreur envoi email : "+result.error);
                    }
                    setView("rapport");
                  }}>{emailSending?"Envoi en cours...":"✓ Confirmer & envoyer"}</button>
                </div>
              </div>
            )}
          </div>
...
Sfuf1XvdsRzWGky";
const EMAIL_CC = "jonathan.laroche@outlook.fr";
const REMOVE_BG_KEY = "EwW4qNTWQbKeGVs1GaQkiX3W";
const COMMERCIAL_ANGLES = ["av_droit", "av_gauche", "ar_gauche", "ar_droit"]; // Les 4 angles détourés automatiquement
const DELTA_LOGO = "data:image/png;base64,";
...
export default function App() {
  ...
  function goHome() { setView("home");setDepStep(0);setRetStep(0);setFoundDossier(null);setOpenZone(null);setSearchDone(false);setCommercialPhotos({});setProcessingPhoto(null);setRetCommercialPhotos({});setRetProcessingPhoto(null);setEmailClient("");setEmailSent(false); }
