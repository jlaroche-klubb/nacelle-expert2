                              ...
                              return (
                                <div key={angle.key} style={{marginBottom:12,padding:"12px 14px",border:"1px solid var(--border)",background:"#f8f9fb"}}>
                                  ...
                                  <div style={{display:"flex",gap:8,alignItems:"center"}}>
                                    ...
                                    <div style={{fontSize:11,color:"var(--muted)",lineHeight:1.6}}>{angle.key==="av_droit"?"Avant droit, ~5m":angle.key==="av_gauche"?"Avant gauche, ~5m":angle.key==="ar_gauche"?"Arrière gauche, ~5m":"Arrière droit, ~5m"}</div>
                                  </div>
                                </div>
                              );
                            })}
