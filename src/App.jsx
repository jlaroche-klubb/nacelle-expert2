...
// Helper function to print PDF then open mailto with pre-filled email
function openEmailClient(emailTo, immat, reportType = "depart") {
  ...
  // Step 1: Trigger print dialog to save PDF
  window.print();
  
  // Step 2: Wait for print dialog, then open mailto
  setTimeout(() => {
