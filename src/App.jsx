...
// Helper function to generate PDF blob and share (mobile) or open mailto (desktop)
async function openEmailClient(emailTo, immat, reportType = "depart") {
  ...
  const body = isDepart
    ? `Bonjour,\n\nVeuillez trouver ci-joint le constat d'état de départ de la nacelle ${immat}.\n\nCe document fera référence lors de la restitution.\n\nCordialement,\nDelta Services\n14 Avenue James de Rothschild · 77164 Ferrières-en-Brie\nTél. +33 (0)1 60 95 47 80`
    : `Bonjour,\n\nSuite à la restitution de la nacelle ${immat}, veuillez trouver ci-joint les constats d'état de départ et de retour.\n\nCordialement,\nDelta Services\n14 Avenue James de Rothschild · 77164 Ferrières-en-Brie\nTél. +33 (0)1 60 95 47 80`;
  
  const filename = `Expertise_${isDepart ? 'Depart' : 'Retour'}_${immat}_${new Date().toLocaleDateString('fr-FR').replace(/\//g,'-')}.pdf`;
  
  // Check if mobile and Web Share API with files is available
