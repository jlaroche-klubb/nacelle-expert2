...
const DRIVE_FOLDER_RETOUR = "1HR5SzLhZrexport const config = { runtime: 'edge' };
...
export default async function handler(req) {
  ...
  try {
    ...
    if (departOnly) {
      // Email état de départ uniquement
      subject = `État de départ · Nacelle ${immat}`;
      emailHTML = `<!DOCTYPE html><html><head><meta charset="utf-8"></head><body style="margin:0;padding:0;background:#f0f2f5;font-family:Arial,sans-serif;"><div style="max-width:600px;margin:0 auto;background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,.08);"><div style="background:#1a2a6e;padding:28px 32px;"><div style="color:#fff;font-size:20px;font-weight:700;letter-spacing:2px;">ÉTAT DE DÉPART</div><div style="color:rgba(255,255,255,.7);font-size:12px;margin-top:4px;">Delta Services · Constat au départ en location</div></div><div style="height:4px;background:linear-gradient(90deg,#1a2a6e,#c8102e);"></div><div style="padding:32px;"><p style="color:#1a2a6e;font-size:16px;font-weight:700;margin:0 0 20px;">Bonjour,</p><p style="color:#444;font-size:14px;line-height:1.6;margin:0 0 24px;">Veuillez trouver ci-dessous le constat d'état de votre nacelle <strong>${immat}</strong> au départ en location. Ce document fera référence lors de la restitution.</p><a href="${linkDepart}" style="display:block;background:#f8f9fb;border:2px solid #1a2a6e;border-radius:6px;padding:16px 20px;text-decoration:none;margin-bottom:24px;"><div style="color:#1a2a6e;font-weight:700;font-size:15px;">📋 Consulter l'état de départ</div><div style="color:#888;font-size:12px;margin-top:4px;">Cliquez pour accéder au document</div></a><p style="color:#888;font-size:12px;line-height:1.6;margin:0;">Pour toute question : <a href="mailto:assistanat.commerce@delta-services.fr" style="color:#1a2a6e;">assistanat.commerce@delta-services.fr</a></p></div><div style="background:#f8f9fb;border-top:1px solid #e0e4ea;padding:16px 32px;font-size:11px;color:#888;text-align:center;">DELTA SERVICES · 14 Avenue James de Rothschild · 77164 Ferrières-en-Brie · Tél. +33 (0)1 60 95 47 80</div></div></body></html>`;
    } else {
      // Email retour avec les deux rapports
      ...
      emailHTML = `<!DOCTYPE html><html><head><meta charset="utf-8"></head><body style="margin:0;padding:0;background:#f0f2f5;font-family:Arial,sans-serif;"><div style="max-width:600px;margin:0 auto;background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,.08);"><div style="background:#1a2a6e;padding:28px 32px;"><div style="color:#fff;font-size:20px;font-weight:700;letter-spacing:2px;">RAPPORT DE RESTITUTION</div><div style="color:rgba(255,255,255,.7);font-size:12px;margin-top:4px;">Delta Services · Comparaison départ / retour</div></div><div style="height:4px;background:linear-gradient(90deg,#1a2a6e,#c8102e);"></div><div style="padding:32px;"><p style="color:#1a2a6e;font-size:16px;font-weight:700;margin:0 0 20px;">Bonjour,</p><p style="color:#444;font-size:14px;line-height:1.6;margin:0 0 24px;">Suite à la restitution de votre nacelle <strong>${immat}</strong>, veuillez trouver ci-dessous les deux constats d'état permettant d'établir les éventuels frais de remise en état.</p><div style="margin-bottom:16px;"><a href="${linkDepart}" style="display:block;background:#f8f9fb;border:1px solid #e0e4ea;border-radius:6px;padding:16px 20px;text-decoration:none;margin-bottom:10px;"><div style="color:#1a2a6e;font-weight:700;font-size:14px;">📋 État de départ</div><div style="color:#888;font-size:12px;margin-top:4px;">Constat d'état au départ en location</div></a><a href="${linkRetour}" style="display:block;background:#fff3f3;border:1px solid #f0c0c0;border-radius:6px;padding:16px 20px;text-decoration:none;"><div style="color:#c8102e;font-weight:700;font-size:14px;">🔍 État de retour</div><div style="color:#888;font-size:12px;margin-top:4px;">Constat d'état et dégâts constatés au retour</div></a></div><p style="color:#888;font-size:12px;line-height:1.6;margin:0;">Pour toute question : <a href="mailto:assistanat.commerce@delta-services.fr" style="color:#1a2a6e;">assistanat.commerce@delta-services.fr</a></p></div><div style="background:#f8f9fb;border-top:1px solid #e0e4ea;padding:16px 32px;font-size:11px;color:#888;text-align:center;">DELTA SERVICES · 14 Avenue James de Rothschild · 77164 Ferrières-en-Brie · Tél. +33 (0)1 60 95 47 80</div></div></body></html>`;
    }
